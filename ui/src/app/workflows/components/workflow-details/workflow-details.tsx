...
export const WorkflowDetails = (props: RouteComponentProps<any>) => {
    // boiler-plate
    ...
    const getItems = () => {
        ...
        const items = Object.keys(workflowOperationsMap).map(actionName => {
            ...
            return {
                ...
                action: () => {
                    if (!confirm(`Are you sure you want to ${workflowOperation.title.toLowerCase()} this workflow?`)) {
                        return;
                    }
                    workflowOperation
                        .action(workflow)
                            ...
                            <div className='workflow-details__step-info'>
                                ...
                                {selectedNode && (
                                    <WorkflowNodeInfo
                                        ...
                                        workflow={workflow}
                                        links={links}
                                        onShowContainerLogs={(container: string) => setSidePanel(`logs:${nodeId}:${container}`)}
